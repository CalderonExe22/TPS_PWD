...
<form style="margin:2%" class="was-validated row g-3" method="post" action="../action/mostrarSaludo.php" 
...
<div class="row-md-4">
  <div class="col-md-4">
    ...
    <input type="number" class="form-control" id="validationServer03" name="edad" required>
